          ...
          <div className="p-4 border-t border-border/20 space-y-3">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <textarea
                  ...
                  rows={1}
                  className="flex-1 bg-transparent text-card-foreground placeholder:text-muted-foreground focus:outline-none text-sm md:text-base resize-none overflow-y-auto scrollbar-styled leading-[1.5] py-0"
