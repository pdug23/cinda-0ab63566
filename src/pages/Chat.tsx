            ...
            <form onSubmit={handleSubmit}>
              <div className="flex items-center gap-2 bg-input/50 rounded-xl px-3 py-2 border border-border/30 focus-within:border-accent/50 transition-colors">
                <textarea
                  ...
                  rows={1}
                  className="flex-1 bg-transparent text-card-foreground placeholder:text-muted-foreground focus:outline-none text-[15px] resize-none overflow-y-auto scrollbar-styled leading-normal"
